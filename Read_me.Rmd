...
The folders here contain R scripts and data files for the article "Fire history and local factors shape ectomycorrhizal fungal communities associated with Pinus ponderosa in mountains of the Madrean Sky Island Archipelago" written by Elizabeth A. Bowman, Daniel R. Hayden, and A.Elizabeth Arnold.
...
You will need to create a figures and results folder before proceeding.
