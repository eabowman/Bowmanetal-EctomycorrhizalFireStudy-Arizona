...
otu.data %>%
  select(Sample_name,Range,Burn_status,Site,Tree,otu.97,Tip_count) %>%
  spread(otu.97,Tip_count) %>%
...
write.csv(SpecRichnessResults.SequenceBased,
          paste0(res.dir, 'SpeciesRichnessResults_RootTipBased.csv'),
          row.names = F)

write.csv(SpecRichness.SequenceBased,
          paste0(res.dir, 'SpeciesRichnessAvg_RootTipBased.csv'),
          row.names = F)
#========================================================================================#
...
write.csv(DivResults.SequenceBased, paste0(res.dir, 'DivResults_RootTipBased.csv'),
          row.names = F)
...
ggsave('Div_FishersAlpha_RootTipBased.tiff', plot = fa.plot, device = 'tiff', path = fig.dir,
...
ggsave('Div_ShannonsDiversity_RootTipBased.tiff', plot = shannon.plot,
